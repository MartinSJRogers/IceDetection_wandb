# -*- coding: utf-8 -*-
"""
Created on Thu Feb 17 10:28:45 2022
...
def uNet(n_classes, start_neurons, learning_rate, n_layers):
    ...
    if n_layers==1:
        convm = Conv2D(start_neurons * 16, (3, 3), activation="relu", padding="same")(pool1)
    else:
    ...
    if n_layers==3:
        convm = Conv2D(start_neurons * 16, (3, 3), activation="relu", padding="same")(pool3)
    elif n_layers > 3:
